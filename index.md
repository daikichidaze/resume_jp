...
- 上記のフレームワークに沿って、下記のような**新規事業**を立ち上げ
  - 豊田通商グループ内における DX プロジェクト推進
    ...
    - 3 年間の活動において、個別案件支援（約 20 件）だけでなく、推進活動の体制そのものを企画・立ち上げ
  - NoCode ツールを用いた新規事業**MVP 開発支援サービス**
    - グループ企業内の新規事業立ち上げを IT の立場から支援
    - ビジネスチームと密な連携とクイックなプロトタイプ開発を両立して遂行できる現地メンバーチームを牽引
...
**生成 AI・データ分析講座の研修コンテンツ作成**

- コンテンツディレクション・作成
  - 企業向けのリスキリング講座のコンテンツ作成及びディレクション
  - チーム内でも生成 AI をフル活用し、3 ヶ月間・約 1000 スライド・動画 36 時間分のコンテンツ開発
...
## Flare (Thailand) Co.,Ltd.（2021 年 11 月〜2023 年 8 月）
...
| NoCode       | bubble.io / Adalo / Make (Integromat)                                                                          |
...
| 期間            | 国                   | 内容                                                                              |
| --------------- | -------------------- | --------------------------------------------------------------------------------- | --- | ------- | ------------------------ | ------------------------------------------------------------------------------- |
| 2019 年-現在    | タイ                 | 海外就職/在タイ企業にて勤務・自らが立ち上げたチームの採用及びマネジメント（4 名） |
| 2022 年-2023 年 | ベトナム(オンライン) | ベトナム人データサイエンティストとのリモート協業                                  |     | 2016 年 | 国際研究インターンシップ | 8 名 8 カ国のチームにて研究活動のインターンシップに参加：1.5 ヶ月寝食を共にする |
...
<!--- Team Community Leaderとして、コミュニティの活性化を目標に活動-->

## データラーニングギルド（2020 年 4 月〜現在）

- データサイエンティストが集うオンラインコミュニティにて活動
- コミュニティ内企画として下記プロジェクトを推進
  - データサイエンス学習者の課題を解決する Web サイト構築のための、クラウドファンディング企画：[Readyfor ページ](https://readyfor.jp/projects/data-learning)
...
## サンカクパートナー（2021 年 6 月〜2022 年 1 月）
